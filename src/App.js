...
import{Ecommerce, Orders, Calendar, Employees, Stacked, Pyramid, Customers, Kanban, Line, Area, Bar, Pie, Financial, ColorMapping, Editor, ColorPicker} from './pages';
import './App.css';
    ...
    <div>
      <BrowserRouter>
        <div className="flex relative dark:bg-main-dark-bg">
          ...
          {/* All the Routes are in separate division  */}
          <div>
            <Routes>
            {/* DashBoard */}
